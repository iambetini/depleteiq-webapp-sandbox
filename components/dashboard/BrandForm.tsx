...
export function BrandForm({
  ...
  // Handle image upload and update form values
  ...
  // Handle form submission with image reset for create mode
  const handleSubmit = async (values: any, helpers: any) => {
    try {
      await onSubmit(values, helpers);
      
      // Reset image after successful creation
      if (mode === "create") {
        clearPreview();
              ...
              <div className="flex flex-col items-center space-y-4 mt-8">
                ...
                {previewUrl && !isUploading && (
                  <div className="text-sm text-orange-100 text-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                    Click the image above to change
                  </div>
                )}
                {isUploading && (
                  <div className="text-sm text-orange-100 text-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
              ...
              <Form className="space-y-10">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-3">
                    <div className="h-1 w-8 bg-gradient-to-r from-[#ff6600] to-[#ff6b00] rounded-full"></div>

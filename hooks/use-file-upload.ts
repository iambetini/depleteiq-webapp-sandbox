...
import { StorageFactory, FileUploadConfig } from '@/lib/storage/storage-factory';
...
export type StorageProviderType = 'aws-s3' | 'local' | 'cloudinary' | 'firebase';
...
export function useFileUpload(config: Partial<FileUploadConfig> = {}): FileUploadState & FileUploadActions {

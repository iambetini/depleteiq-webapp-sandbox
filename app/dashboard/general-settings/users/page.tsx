      ...
      cell: ({ row }) => (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem onClick={() => router.push(`/dashboard/general-settings/users/${row.original.uuid}`)}>
              <Eye className="mr-2 h-4 w-4" />
              View Details
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => router.push(`/dashboard/general-settings/users/${row.original.uuid}/edit`)}>
  ...
  return (
    <div>
      <ListPageHeader
        ...
        showAddButton={true}
        onAdd={() => router.push("/dashboard/general-settings/users/create")}
        addLabel="Add User"

...
export default function EditPromoterPage() {
  ...
  const initialValues = {
    market_id: promoter.market_assignment?.uuid || promoter.market?.uuid || '',
    first_name: promoter.first_name || promoter.user?.first_name || '',
    last_name: promoter.last_name || promoter.user?.last_name || '',
    email: promoter.email || promoter.user?.email || '',

  ...
  <CardContent className="space-y-6">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        ...
        <div className="text-lg text-gray-900 font-medium">{session.user.first_name || "Not provided"}</div>
      </div>
      <div>
        <Label className="block text-xs font-semibold text-gray-500 mb-1">Last Name</Label>
        <div className="text-lg text-gray-900 font-medium">{session.user.last_name || "Not provided"}</div>
      </div>
    </div>
    <div>
      <Label className="block text-xs font-semibold text-gray-500 mb-1">Email Address</Label>
      <div className="text-lg text-gray-900 font-medium">{session.user.email}</div>
    </div>
    <div>
      <Label className="block text-xs font-semibold text-gray-500 mb-1">Role</Label>
      <Badge className="bg-[#ff6600] text-white px-3 py-1 text-sm font-medium">{roleDisplay}</Badge>
    </div>
  </CardContent>
</Card>
                </div>

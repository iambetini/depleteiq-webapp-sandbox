      ...
      cell: ({ row }) => (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem onClick={() => router.push(`/dashboard/locations/lgas/${row.original.uuid}`)}>
              <Eye className="mr-2 h-4 w-4" />
              View Details
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => router.push(`/dashboard/locations/lgas/${row.original.uuid}/edit`)}>
  ...
  return (
    <div>
      <ListPageHeader
        ...
        description="Manage Local Government Areas (LGAs)"
        showAddButton={true}
        onAdd={() => router.push("/dashboard/locations/lgas/create")}
        addLabel="Add LGA"
      />
